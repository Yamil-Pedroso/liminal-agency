...
export const agTeam: TeamProps[] = [
  {
    ...
    avatar: "./images/about/team/img1.webp",
    grettings: "¡Hola!",
  },
  {
    name: "Talitee Amsel",
    ...
    avatar: "./images/about/team/img2.webp",
  ...
  },
  {
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram],
    avatar: "./images/about/team/img3.webp",
    grettings: "Hi!",
  },
  {
    name: "Mila Corven",
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram],
    avatar: "./images/about/team/img4.webp",
    grettings: "Привет!",
  },
  {
    name: "Élio Tanaka",
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram],
    avatar: "./images/about/team/img5.webp",
    grettings: "Bonjour!",
  },
  {
    name: "Karuh Lumina",
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram, FaXTwitter],
    avatar: "./images/about/team/img6.webp",
    grettings: "miau!",
  },
  {
    name: "Adrian Volk",
    position: "CTO",
    icon: [FaLinkedinIn, FaGithub, FaInstagram, FaXTwitter],
    avatar: "./images/about/team/img7.webp",
    grettings: "Olá!",
  },
  {
    name: "Renata Sorel",
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram],
    avatar: "./images/about/team/img8.webp",
    grettings: "Nǐ hǎo",
  },
  {
    ...
    icon: [FaLinkedinIn, FaGithub, FaInstagram],
    avatar: "./images/about/team/img9.webp",
    grettings: "Hallo!",
  },
];
